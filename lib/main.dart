import 'package:data_siswa_pencak_silat/data/database.dart';
...
class _MyHomePageState extends State<MyHomePage> {
          ...
          return AlertDialog(
            content: SingleChildScrollView(
              ...
              child: Column(children: [
                Text((todo != null ? "Detail " : "Tambah ") + " Nama Siswa"),
                SizedBox(
                  height: 20,
                ),
                TextFormField(
                ...
                TextFormField(
                  ...
                  maxLines: 2,
                  decoration: InputDecoration(
                      border: OutlineInputBorder(), hintText: "Nomor, Sabuk"),
                ),
                SizedBox(
                  height: 10,
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Data Siswa PSHT")),
      body: SafeArea(
